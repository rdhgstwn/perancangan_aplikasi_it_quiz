...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(nilai >= 80) {
            txt_comment.setText("Bagus Sekali!");
        }else if(nilai >= 60) {
            txt_comment.setText("Bagus!");
        }else {
            txt_comment.setText("belajar lagi ya! :)");
        }

        cobalagi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ResultActivity.this, MainstartActivity.class);
                startActivity(i);
                finish();
            }
        });
